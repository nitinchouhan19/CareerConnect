...
const RecruiterJobCard = ({ _id , title ,jobDescription }) => {
  return (
    <>
    ...
    //         </Link>
    //         <p class="mb-3 font-normal text-gray-500 ">{jobDescription.slice(0,150)}</p>
    //         <Link to = {`/jobapplicants/${_id}`}  class="inline-flex items-center text-blue-600 hover:underline">
    //             See Applicants
